...
export function NewGameBoard({ onClick }: NewGameBoardProps) {
  return (
    <button
      onClick={onClick}
      className="group relative h-[calc(3*2.5rem+2*1px)] w-[calc(3*2.5rem+2*1px)] rounded border border-dashed border-zinc-100 transition-colors duration-200 hover:border-zinc-200 dark:border-zinc-800/50 dark:hover:border-zinc-800"
    >
